...
// Read the custom rules from the text file so the user can edit them easily
...
ORDER FLOW:
Step 1: If the user provides an incomplete order, politely ask for what is missing (Name, Phone, Address, Product Details, Quantity).
